      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="p-5">
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        <dt className="text-sm font-medium text-gray-500 truncate">Current Loans</dt>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="p-5">
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        <dt className="text-sm font-medium text-gray-500 truncate">Reading Goal</dt>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="p-5">
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        <dt className="text-sm font-medium text-gray-500 truncate">Reading Time</dt>
                        <dd className="text-lg font-medium text-gray-900">42h</dd>
                      </dl>
                    </div>
                  </div>
                </div>
              ...
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-gray-600">Returned "The Great Gatsby" - 2 days ago</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    <span className="text-sm text-gray-600">Borrowed "1984" - 1 week ago</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span className="text-sm text-gray-600">Completed reading goal for March</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {activeTab === 'books' && (
          <div className="px-4 py-6 sm:px-0">
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Available Books</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <h4 className="font-semibold text-gray-900">Sample Book Title</h4>
                    <p className="text-sm text-gray-600">Author Name</p>
                    <button className="mt-2 bg-teal-600 text-white px-4 py-2 rounded-md text-sm hover:bg-teal-700 transition-colors">
                      Borrow
                    </button>
                  </div>
                </div>
